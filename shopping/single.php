...
if(isset($_GET['id'])) {
    ...
    if(isset($_SESSION['user_id']))  {
        $select = $conn->prepare("SELECT * FROM cart WHERE pro_id = :id AND user_id  = :user_id");
        $select->execute([':id' => $id, ':user_id' => $_SESSION['user_id']]);
    }
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="product p-4">
                        ...
                        <div class="mt-4 mb-3"> 
                            <h5 class="text-uppercase" id="name" value=""><?php echo $product->name; ?></h5>
                          ...
                          <form method="post" id="form-data">
                                ...
                                <?php if(isset($_SESSION['user_id'])) : ?>
                                    ...
                                    <?php if($select->rowCount() > 0) : ?>
                                        <button id="submit" name="submit" type="submit" disabled class="btn btn-primary text-uppercase mr-2 px -4">Added to cart</button>
                                    <?php else : ?>
                                        <button id="submit" name="submit" type="submit" class="btn btn-primary text-uppercase mr-2 px-4">Add to cart</button>
                                    <?php endif; ?>
                                <?php endif ?>
                                </div>
                            </form>
